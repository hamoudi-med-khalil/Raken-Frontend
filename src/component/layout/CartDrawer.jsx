...
const CartDrawer = ({ toggleCartDrawer, cartDrawerOpen }) => {
    ...
    return (
        <div className={`fixed top-0 right-0 bg-white shadow-lg w-1/4 sm:w-1/2 md:w-1/4 h-full transform transition-transform duration-300
    ${cartDrawerOpen ? 'translate-x-0' : 'translate-x-full'} flex flex-col z-50`} >
            ...
            <div className='bg-white sticky bottom-0 p-4'>
                <button className='w-full bg-black text-white font-semibold py-3 px-2 rounded-lg hover:bg-gray-800 transition'>CheckOut</button>
